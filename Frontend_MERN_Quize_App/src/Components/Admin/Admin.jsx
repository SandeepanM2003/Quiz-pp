...
I have gained skills in languages like C ,C++ and Python.
In the Web Development domain I have grasp over HTML ,CSS and JavaScript & Nodejs .

For designing aspect I use Figma,Adobe Xd,Sketch,Illustrator.

I am currently pursuing my B-Tech degree in Computer Science and Engineering at Veer Surendra Sai university of Technology (formerly UCE),Burla.

I want to explore all domains and want to built many projects .I am currently interested to explore in the domain of ML and AI .
I want to be a Full stack Developer in future.
            </p>
          </div>
